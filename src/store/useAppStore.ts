...
type WritingPhase = 'select-flower' | 'part-a' | 'part-a-done' | 'ai-from-a' | 'part-b' | 'part-c' | 'finalize' | 'free-write';
    ...
    (set, get) => ({
      ...
      seedSamplePoems: () => {
        ...
        const samplePoems: PoemDraft[] = [
          { id: 's1', flowerId: 'lilac', authorName: '별빛', authorId: 'sample-1', qaItems: [], sentences: [], partBText: '', partCText: '', title: '봄바람에게', finalPoem: '라일락 향기 흩날리는\n골목길을 걸으면\n네가 떠오른다\n\n바람이 속삭이듯\n스쳐지나간 그 봄날\n아직도 여기 머문다', background: 'bg-purple-50', isCompleted: true, isAutoGenerated: false, createdAt: '2026-02-20T10:00:00Z', likes: 24, likedBy: [], views: 45, reports: [], isHidden: false, isPrivate: false, comments: [] },
          { id: 's2', flowerId: 'balloon-flower', authorName: '구름', authorId: 'sample-2', qaItems: [], sentences: [], partBText: '', partCText: '', title: '어린 날의 노래', finalPoem: '풀밭에 누워\n구름을 세던 날\n세상은 참 넓었고\n\n하루는 참 길었다\n그때의 웃음이\n아직 귓가에 맴돈다', background: 'bg-pink-50', isCompleted: true, isAutoGenerated: false, createdAt: '2026-02-19T10:00:00Z', likes: 18, likedBy: [], views: 32, reports: [], isHidden: false, isPrivate: false, comments: [] },
          { id: 's3', flowerId: 'rose', authorName: '달빛', authorId: 'sample-3', qaItems: [], sentences: [], partBText: '', partCText: '', title: '사랑이란', finalPoem: '가시 위에 핀\n붉은 꽃잎 하나\n\n아프지만 놓을 수 없는\n그 이름을\n오늘도 부른다', background: 'bg-red-50', isCompleted: true, isAutoGenerated: false, createdAt: '2026-02-18T10:00:00Z', likes: 31, likedBy: [], views: 67, reports: [], isHidden: false, isPrivate: false, comments: [] },
          { id: 's4', flowerId: 'forsythia', authorName: '햇살', authorId: 'sample-4', qaItems: [], sentences: [], partBText: '', partCText: '', title: '희망의 노래', finalPoem: '겨울이 깊을수록\n봄은 가까이 오고\n\n어둠이 짙을수록\n별은 더 밝게 빛나니\n\n우리도 그렇게\n피어나리라', background: 'bg-yellow-50', isCompleted: true, isAutoGenerated: false, createdAt: '2026-02-17T10:00:00Z', likes: 42, likedBy: [], views: 88, reports: [], isHidden: false, isPrivate: false, comments: [] },
          { id: 's5', flowerId: 'portulaca', authorName: '솜사탕', authorId: 'sample-5', qaItems: [], sentences: [], partBText: '', partCText: '', title: '천진난만', finalPoem: '웃음이 꽃처럼\n피어나는 아이처럼\n\n거짓 없이\n있는 그대로\n아름다운 것들이\n\n세상에 가득하길', background: 'bg-cream-100', isCompleted: true, isAutoGenerated: false, createdAt: '2026-02-16T10:00:00Z', likes: 15, likedBy: [], views: 21, reports: [], isHidden: false, isPrivate: false, comments: [] },
          { id: 's6', flowerId: 'moss-phlox', authorName: '나무', authorId: 'sample-6', qaItems: [], sentences: [], partBText: '', partCText: '', title: '묵묵한 사랑', finalPoem: '말없이 내려놓은\n따뜻한 밥상 위에\n\n세상 모든 말보다\n깊은 사랑이 있다\n\n그걸 알아차린 건\n한참이 지나서였다', background: 'bg-green-50', isCompleted: true, isAutoGenerated: false, createdAt: '2026-02-15T10:00:00Z', likes: 27, likedBy: [], views: 53, reports: [], isHidden: false, isPrivate: false, comments: [] },
        ];
